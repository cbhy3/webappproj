...
class replyTicket(FlaskForm):
    body = StringField('Reply', validators=[InputRequired(),Length(min=25, max = 3000)],widget=TextArea())
    submit = SubmitField('Submit', name = 'reply_ticket_submit')